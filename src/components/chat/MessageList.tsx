                      ...
                      {message.parts.map((part, partIndex) => {
                        switch (part.type) {
                          ...
                          case "tool-invocation": {
                            ...
                            const getToolLabel = (t: typeof tool) => {
                              const path = t.args?.path?.replace(/^\//, "") ?? t.toolName;
                              if (t.toolName === "file_manager" && t.args?.command === "rename" && t.args?.new_path) {
                                const newPath = t.args.new_path.replace(/^\//, "");
                                return `${path} → ${newPath}`;
                              }
                              return path;
                            };
